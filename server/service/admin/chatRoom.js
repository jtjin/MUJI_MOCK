...
class ChatRoomService {
    ...
    getChatRoomsListById(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield index_1.default.messagesModule.getChatRoomsListById({
                    adminId: userId,
                });
            }
            catch (error) {
    ...
    getChatRoomHistory(room) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield index_1.default.messagesModule.getMessagesByRoom(room);
            }
            catch (error) {
                throw error;
            }
